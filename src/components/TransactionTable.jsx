...
const CategoryBadge=({category})=>{
    ...
    const {borderColor,
        backgroundColor,
        textColor,
        chipBackgroundColor,} =transactionCategoryStyles[category]||transactionCategoryStyles.default
...
TransactionTable.propTypes = transactionTableProps
CategoryBadge.propTypes=categoryBadgeProps
